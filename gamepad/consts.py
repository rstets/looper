...
SPEEDLINK_ALT = {
        ...
        'message': [
            ...
            {'name': BUTTONS_1, 'buttons': [
                ...
                {'type': CC_DELTA_BUTTONS, 'cc': 63, 'delta': 0, 'name': 'ARROW (BOTTOM)', 'number': 4},
                {'type': CC_DELTA_BUTTONS, 'cc': 63, 'delta': 127, 'name': 'ARROW (TOP)', 'number': 0},
                {'type': CC_DELTA_BUTTONS, 'cc': 64, 'delta': 0, 'name': 'ARROW (LEFT)', 'number': 6},
                {'type': CC_DELTA_BUTTONS, 'cc': 64, 'delta': 127, 'name': 'ARROW (RIGHT)', 'number': 2},

                {'type': NOTE, 'note': 40, 'name': 'BTN 3 (BOTTOM)', 'value': 79},
                {'type': NOTE, 'note': 42, 'name': 'BTN 1 (TOP)', 'value': 31},
                {'type': NOTE, 'note': 41, 'delta': 0, 'name': 'BTN 4 (LEFT)', 'value': 143},
                {'type': NOTE, 'note': 43, 'name': 'BTN 2 (RIGHT)', 'value': 47},

            ]},
            {'name': BUTTONS_2, 'buttons': [
                {'type': NOTE, 'note': 36, 'name': 'LEFT TOP SHIFT', 'value': 1},
                {'type': NOTE, 'note': 37, 'name': 'LEFT BOTTOM SHIFT', 'value': 4},
                {'type': NOTE, 'note': 38, 'name': 'RIGHT TOP SHIFT', 'value': 2},
                {'type': NOTE, 'note': 39, 'name': 'RIGHT BOTTOM SHIFT', 'value': 8},
                {'type': CC_DELTA_BUTTONS, 'cc': 61, 'delta': 0, 'name': 'SELECT', 'value': 16},
                {'type': CC_DELTA_BUTTONS, 'cc': 61, 'delta': 127, 'name': 'START', 'value': 32},
                {'type': CC_DELTA_BUTTONS, 'cc': 62, 'delta': 0, 'name': 'LEFT STICK', 'value': 64},
                {'type': CC_DELTA_BUTTONS, 'cc': 62, 'delta': 127, 'name': 'RIGHT STICK', 'value': 128},
            ]},
            None,
        ],
    }
