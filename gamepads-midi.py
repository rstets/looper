...
notes = {}
notes[MIDI_CHANNEL_1] = {}
notes[MIDI_CHANNEL_2] = {}
...
messages = {}
messages[MIDI_CHANNEL_1] = {}
messages[MIDI_CHANNEL_2] = {}
...
GAMEPADS = [
    {
        ...
        'message': [
            None,
            {'name': LEFT_X, 'type': CC, 'number': MIDI_MESSAGES[0], 'inverse': False},
            {'name': LEFT_Y, 'type': CC, 'number': MIDI_MESSAGES[1], 'inverse': True},
            {'name': RIGHT_X, 'type': CC, 'number': MIDI_MESSAGES[2], 'inverse': False},
            {'name': RIGHT_Y, 'type': CC, 'number': MIDI_MESSAGES[3], 'inverse': True},
            {'name': BUTTONS_1, 'type': NOTE, 'buttons': [
                ...
                {'note': MIDI_NOTES[14], 'name': 'ARROW (BOTTOM)', 'number': 4},
    ...
    },
    {
        ...
        'message': [
            ...
            {'name': BUTTONS_1, 'type': NOTE, 'buttons': [
                ...
                {'note': MIDI_NOTES[10], 'name': 'BTN 3 (BOTTOM)', 'value': 79},
                                ...
                                for btn in msg['buttons']:
                                    if btn['note']:
                                        if 'number' in btn.keys():
                                            if btn['number'] == data:
                                                midi_note_on(info['channel'], btn['note'])
                                            else:
                                                midi_note_off(info['channel'], btn['note'])
